<template>
  <section class="page-simple-container">
    <article class="prose">
      ...
      <p>
        ...
        erfasst Alfahosting verschiedene Logfiles inklusive Ihrer IP-Adressen.
      </p>
      <p>
...
useSeoMeta({
  ...
  robots: 'noindex',
  description:
    'Datenschutzerklärung von Team Escalate nach DSGVO. Informationen zur Verarbeitung personenbezogener Daten auf dieser Webseite.',
  ogTitle: 'Datenschutz | Team Escalate',
  ogDescription:
    'Datenschutzerklärung der Webseite von Team Escalate gemäß DSGVO mit Hinweisen zur Datenverarbeitung.',
  ogType: 'website',
